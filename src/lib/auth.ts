 ...
 */
export async function createOrUpdateUserDocument(uid: string, email: string, nome: string, role: UserRole, senha?: string, cnpj?: string, telefone?: string): Promise<Usuario> {
